...
export default function SearchSection() {
  ...
  return (
    <div className="flex items-center space-x-2 mb-4">
      ...
      <Button onClick={() => { refreshData(); setRefreshDisabled(true); }} disabled={refreshDisabled}>
        <RefreshCw /> {refreshDisabled ? 'Disabled' : 'Refresh Now'}
      </Button>
      <select className="p-2 rounded bg-gray-800 text-white" value={autoRefreshInterval} onChange={(e) => setAutoRefreshInterval(Number(e.target.value))}>
